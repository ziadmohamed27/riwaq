...
export default async function AddressesPage({ searchParams }: PageProps) {
  ...
  // رابط العودة: إذا جاء من checkout نعيده إليه، وإلا للـ account
  const backHref = searchParams.redirect ?? '/account'
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-stone-50">
      <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
        ...
        {/* ── Banner عند القدوم من checkout ─────────────────────────── */}
        {searchParams.redirect?.startsWith('/checkout') && (
